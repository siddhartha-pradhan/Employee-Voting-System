<%@ Page Title="Employee Detail" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeDetail.aspx.cs" Inherits="EmployeeVotingSystem.Forms.Complex.EmployeeDetail" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header text-center text-white" style="background-color: #7322CE">

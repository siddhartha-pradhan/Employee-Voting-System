...
namespace EmployeeVotingSystem
{
	public partial class _Default : Page
	{
		...
		public void GetChartData()
		{
			...
			var employees = pieChart.Series["EmployeeSeries"];

			pieChart.Series["EmployeeSeries"].Color = Color.MediumPurple;

			var value = _dataLayer.VoteCount();

			foreach (var count in value)
			{
				employees.Points.AddXY(count.EmployeeName, count.Count);
			}
		}
	}
}